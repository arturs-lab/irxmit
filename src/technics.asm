...
IRDpuls equ     .4              ; light pulse 400 us
IRDzero equ     .12              ; "zero" 400 us
IRDone  equ     .28              ; "one" 1200 us
IRBit	equ	0		; bit 3 of port IRport that controls IR transmitter
        ...
        movlw   040h             ; initialize message codes to
        movwf   ind0            ; 40 04 05 10 D0 C5
        movlw	004h
        incf    fsr,f
        movwf   ind0
        movlw	005h
...
IRSync  bsf     IRport,IRBit     ; enable IR transmitter
        ...
        call    IRwait
IRData  movlw   6               ; number of bytes to be sent
        movwf   buf
